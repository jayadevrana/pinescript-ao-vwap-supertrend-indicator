...
This repository contains a Pine Script source file saved as `pinescript_ao_vwap_supertrend_indicator.txt` so it opens easily on GitHub and can be copied into TradingView.
...
3. Copy the code from `pinescript_ao_vwap_supertrend_indicator.txt`.
